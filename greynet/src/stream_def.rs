...
#[derive(Debug, Clone)]
pub struct FromDefinition { pub fact_type: TypeId, pub fact_type_name: &'static str }
impl FromDefinition { pub fn new<T: GreynetFact>() -> Self { Self { fact_type: TypeId::of::<T>(), fact_type_name: std::any::type_name::<T>() } } }

#[derive(Clone)]
pub struct FilterDefinition<S: Score> { pub source: Box<StreamDefinition<S>>, pub predicate_id: FunctionId, pub _phantom: PhantomData<S> }
impl<S: Score> FilterDefinition<S> { pub fn new(source: StreamDefinition<S>, predicate_id: FunctionId) -> Self { Self { source: Box::new(source), predicate_id, _phantom: PhantomData } } }

#[derive(Clone)]
pub struct JoinDefinition<S: Score> { pub left_source: Box<StreamDefinition<S>>, pub right_source: Box<StreamDefinition<S>>, pub joiner_type: JoinerType, pub left_key_fn_id: FunctionId, pub right_key_fn_id: FunctionId, pub _phantom: PhantomData<S> }
impl<S: Score> JoinDefinition<S> { pub fn new(source: StreamDefinition<S>, other: StreamDefinition<S>, joiner: JoinerType, left_key: FunctionId, right_key: FunctionId) -> Self { Self { left_source: Box::new(source), right_source: Box::new(other), joiner_type: joiner, left_key_fn_id: left_key, right_key_fn_id: right_key, _phantom: PhantomData } } }

#[derive(Clone)]
pub struct ConditionalJoinDefinition<S: Score> { pub source: Box<StreamDefinition<S>>, pub other: Box<StreamDefinition<S>>, pub should_exist: bool, pub left_key_fn_id: FunctionId, pub right_key_fn_id: FunctionId, pub _phantom: PhantomData<S> }
impl<S: Score> ConditionalJoinDefinition<S> { pub fn new(source: StreamDefinition<S>, other: StreamDefinition<S>, should_exist: bool, left_key: FunctionId, right_key: FunctionId) -> Self { Self { source: Box::new(source), other: Box::new(other), should_exist, left_key_fn_id: left_key, right_key_fn_id: right_key, _phantom: PhantomData } } }

#[derive(Clone)]
pub struct GroupDefinition<S: Score> { pub source: Box<StreamDefinition<S>>, pub key_fn_id: FunctionId, pub collector_supplier: CollectorSupplier, pub _phantom: PhantomData<S> }
impl<S: Score> GroupDefinition<S> { pub fn new(source: StreamDefinition<S>, key_fn_id: FunctionId, collector_supplier: CollectorSupplier) -> Self { Self { source: Box::new(source), key_fn_id, collector_supplier, _phantom: PhantomData } } }

#[derive(Clone)]
pub struct ScoringDefinition<S: Score> { pub source: Box<StreamDefinition<S>>, pub impact_fn_id: FunctionId, pub constraint_id: ConstraintId, pub _phantom: PhantomData<S> }
impl<S: Score> ScoringDefinition<S> { pub fn new(source: StreamDefinition<S>, impact_fn_id: FunctionId, constraint_id: ConstraintId) -> Self { Self { source: Box::new(source), impact_fn_id, constraint_id, _phantom: PhantomData } } }

#[derive(Clone)]
pub struct FlatMapDefinition<S: Score> { pub source: Box<StreamDefinition<S>>, pub mapper_fn_id: FunctionId, pub _phantom: PhantomData<S> }
impl<S: Score> FlatMapDefinition<S> { pub fn new(source: StreamDefinition<S>, mapper_fn_id: FunctionId) -> Self { Self { source: Box::new(source), mapper_fn_id, _phantom: PhantomData } } }
...
impl<A, S: Score + 'static> Stream<A, S> {
    ...
    fn new_with_context(definition: StreamDefinition<S>, factory: Weak<RefCell<ConstraintFactory<S>>>, context: Option<ConstraintId>) -> Self {
